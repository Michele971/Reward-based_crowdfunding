...
#mnemonic1 = "grief close obey friend tide pen undo addict jump among pulp engage fuel require layer breeze render clean public clutch access tape seed abstract mother"
mnemonic1 = "squeeze social impulse disease pencil gloom expect escape jewel panda disease cry spin flame aspect kiss lizard parade fat salt dial erosion thought able strategy" #COMPANY PASSPHASE (the company that own our tokens)
mnemonic2 = "tray basket blur resist little about fatal faculty shiver else pride mule option ride print sunny client chunk hundred loyal empower uniform vehicle abstract arrange"
#mnemonic3 = "february tray woman acquire result mimic smart above two excuse clog common short point funny smile idle gossip truly journey dry display festival absorb cinnamon"
...
algod_token = "nYYIqswHmq3C0xpWSNUYb8073dFpTUAu6tg1GXlw"
headers = {
...
# Account 1 address: JY5W3LIOHKBHKM2GOMZG3LRYOQTTRTWX2QPXMIAR75H7EK47HUBGFBU6UM
# Account 2 address: 
...
txn = AssetConfigTxn(
    ...
    unit_name="SYS_2",
    asset_name="Solar System Test 2",
    manager=accounts[1]['pk'],
    reserve=accounts[1]['pk'],
    strict_empty_address_check =False,
    freeze=None, #we don't want that somebody can freeze or claback the tokens, neither us.
    clawback=None,
    url="workinprogess", 
    decimals=6)
